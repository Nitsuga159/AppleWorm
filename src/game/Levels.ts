...
class Levels {
    ...
    public static readonly TOTAL_LEVELS = 32
    ...
    constructor() {
        ...
        d.addEventListener("keydown", (e) => {
            if(game.getMode() === MODE.EDITOR || game.getMode() === MODE.NONE) return;
            if(e.key === "e") return this.buttonsContainer.classList.toggle("hidden")
